package com.example.gohealthlyapplication.alarmreminder.data;
...
public class AlarmReminderContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.gohealthlyapplication.alarmreminder";
